...
public class ToggleableWindow : MonoBehaviour
{
    ...
    public virtual void Update() {
        ...
        if ((Keyboard.current.escapeKey.wasPressedThisFrame || (CustomInputManager.LastInputWasGamepad && Gamepad.current.buttonEast.wasPressedThisFrame)) && !m_closedAllThisFrame)
        {
